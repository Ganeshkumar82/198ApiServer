...
router.post('/addsubscription', async function(req, res, next) {
  try {
    ...
    console.error(`Error while creating customer new subscription`, err.message);
    next(err);
  }
});
...
router.post('/totalsite',async function(req,res, next){
  try{
    ...
    console.error('Error while fetching the total number of sites',err.message);
    next(err);
  }
});
...
router.post('/noofcamera',async function(req,res, next){
  try{
    ...
    console.error('Error while fetching the No of cameras for each site',err.message);
    next(err);
  }
});
...
router.post('/totalevents',async function(req,res, next){
  try{
    ...
    console.error('Error while fetching the Total Number of Events',err.message);
    next(err);
  }
});
...
router.post('/totaldevice',async function(req,res, next){
  try{
    ...
    console.error('Error while fetching the total number of device',err.message);
    next(err);
  }
});
...
router.post('/noofdevice',async function(req,res, next){
  try{
    ...
    console.error('Error while fetching the No of device for each site',err.message);
    next(err);
  }
});
...
router.post('/noofspeakers',async function(req,res, next){
  try{
    ...
    console.error('Error while fetching the No of speakers for each site',err.message);
    next(err);
  }
});
...
router.post('/realevent',async function(req,res, next){
 ...
 router.post('/addconfig', async function(req, res, next) {
  try {
    ...
    console.error(`Error while adding the config file to the site controller`, err.message);
    next(err);
  }
});
...
router.post('/dblist', async function(req,res,next){
  try{
    ...
    console.error(`Error while Fetching the Available database list ${er.message}`);
    next(er);
  }
});
...
router.post('/configpaths', async function(req,res,next){
  try{
    ...
    console.error(`Error while Fetching the Available Paths for the storage ${er.message}`);
    next(er);
  }
});
...
router.post('/sitemodify', async function(req,res,next){
  try{
    ...
    console.error(`Error while Modifying the Site status like activate/deactivate/delete ${er.message}`);
    next(er);
  }
});
//Fetch the Storage path  of the site controller
router.post('/devicemodify', async function(req,res,next){
  try{
    ...
    console.error(`Error while Modifying the Device status like activate/deactivate/delete ${er.message}`);
    next(er);
  }
});
...
router.post('/updatesite' , async function(req,res,next){
   try{
    ...
    console.error(`Error while Updating the site Info for Site controller ${er.message}`);
    next(er);
   }
});
...
router.post('/cameralist', async function(req,res,next){
  try{
    ...
    console.error(`Error while Fetching the camera list of the device. ${er.message}`);
    next(er);
  }
});
...
router.post('/cameraseverity', async function(req,res,next){
  try{
     ...
     console.error(`Error while adding the Camera Severity of the site -> ${er.message}`);
     next(er);
  }
});
...
router.post('/getsitesub', async function(req,res,next){
  try{
    ...
    console.error(`Error while fetching the subscription details of the site -> ${er.message}`);
    next(er);
  }
});
...
router.post('/getsubscription' , async function(req,res,next){
  try{
    ...
    console.error(`Error while the fetching the subscription list. ${er.message}`);
    next(er);
  }
});
...
router.post('/getnotificationserver', async function(req,res,next){
  try{
    ...
    console.error(`Error while fetching the notification server list. -> ${er.message}`);
    next(er);
  }
});
...
router.post('/updatenotificationserver', async function(req,res,next){
  try{
    ...
    console.error(`Error while updating the notification server list. -> ${er.message}`);
    next(er);
  }
});
...
router.post('/addstorageserver', async function(req,res,next){
  try{
    ...
    console.error(`Error while fetching the Add storage server -> ${er.message}`);
    next(er);
  }
});
...
router.post('/fetchstoragepath', async function(req,res,next){
  try{
    ...
    console.error(`Error while fetching the available storage server -> ${er.message}`);
    next(er);
  }
});
...
router.post('/fetchapplicationserver', async function(req,res,next){
  try{
    ...
    console.error(`Error while Fetching the application server -> ${er.message}`);
    next(er);
  }
});
...
router.post('/updateapplicationserver',async function(req,res,next){
  try{
    ...
    console.error(`Error while updating the application server -> ${er.message}`);
    next(er);
  }
});
...
router.post('/exportsite', async function(req,res,next){
  try{
    ...
    console.error(`Error while fetching the site for exporting -> ${er.message}`);
    next(er);
  }
});
...
router.post('/camerasnapshot', async function(req,res,next){
 try{
  ...
  console.error(`Error while taking the snapshot for the camera id > ${er.message}`);
  next(er);
 }
});
...
router.post('/devicestop', async function(req,res,next){
  try{
    ...
    console.error(`Error while updating the site controller status -> ${er.message}`);
    next(er);
  }
});
...
router.post('/updatelbserver', async function(req,res,next){
  try{
    ...
    console.error(`Error while updating the load balancer server -> ${er.message}`);
    next(er);
  }
});
...
router.post('/modifynotifyserver', async function(req,res,next){
  try{
    ...
    console.error(`Error while deleting the notification server -> ${er.message}`);
    next(er);
  }
});
...
router.post('/modifylbserver', async function(req,res,next){
  try{
    ...
    console.error(`Error while modify the load balancer server -> ${er.message}`);
    next(er);
  }
});
...
router.post('/modifycomserver', async function(req,res,next){
  try{
    ...
    console.error(`Error while modify the Communication server -> ${er.message}`);
    next(er);
  }
});
...
router.post('/dashboardcount', async function(req,res,next){
  try{
    ...
    console.error(`Error while fetching the total number of active and inactive server -> ${er.message}`);
    next(er);
  }
});
...
router.post('/updateaiprocess', async function(req,res,next){
  try{
    ...
    console.error(`Error while Updating the Process ID for AI -> ${er.message}`);
    next(er);
  }
});
...
router.post('/getaiprocess', async function(req,res,next){
  try{
    ...
    console.error(`Error while getting the Process id of the AI machine -> ${er.message}`);
    next(er);
  }
});
...
router.post('/airollback', async function(req,res,next){
   try{
     ...
     console.error(`Error while Fetch the AI old rollback path -> ${er.message}`);
     next(er);
   }
});
...
router.post('/getsiteprocess', async function(req,res,next){
  try{
    ...
    console.error(`Error while getting the Process id of the Site controller -> ${er.message}`);
    next(er);
  }
});
